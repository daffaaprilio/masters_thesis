...
```shell
./docker/run.sh python3 analysis/06_vcf_benchmark.py
```
...
```shell
./docker/run.sh python3 analysis/05_variant_landscape.py
```
...
```shell
./docker/run.sh bash analysis/02_private_variants.sh
```
...
```shell
./docker/run.sh bash analysis/03_merge_vcf.sh
```
...
```shell
./docker/run.sh python3 analysis/04_annot_vcf_to_tsv.py -v <vcf> -o analysis/data/tsv/
```
